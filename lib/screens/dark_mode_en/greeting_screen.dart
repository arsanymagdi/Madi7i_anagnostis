...
import 'home_screen.dart'; // Make sure it's in the same folder

class DarkEnGreetingScreen extends StatelessWidget {
  const DarkEnGreetingScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          const SizedBox(height: 60), // Space above cross
